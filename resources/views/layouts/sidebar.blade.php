...
<div class="bg-blue-100 w-48">
  ...
  <a href="{{ route('users.index') }}" class="{{ request()->routeIs('users') ? 'bg-gray-300' : '' }} text-black text-xl transition-all duration-500 hover:text-white hover:bg-black font-bold p-3 block">
    {{ "Users" }}
  </a>
